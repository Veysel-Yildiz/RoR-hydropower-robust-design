...
O = load('tepe_observed.txt');
O_60_50 = load('tepe_50x60_years.txt');
...
X = load('X200_tepe.txt');
X(201,:) = [1.55, 2.42, 2.42, 2, 3];%identical 10% discount of em cost
X(202,:) = [1.55, 2.42, 2.42, 2, 3];%identical
%% project variables
...
save ('outputTEPE','AR', 'AC', 'WEP1','BC','power', 'AAE', 'T_cost','NPV', 'PayB','Y_ae','multiplier','FDCpars','kpn','PB10','PB15','PB20','nNPV','-v7.3')
