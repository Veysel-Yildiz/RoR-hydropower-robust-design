...
Q = load('karacay_1000years.txt');

%HP.MFD = O; %  HP.MFD = 0; % already considered, the minimum environmental flow (m3/s)
...
Par_info.max = [5.00 20 3.0 tj 3.499];  % If 'latin', max values
