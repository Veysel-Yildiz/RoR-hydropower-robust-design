...
Q = load('kaplan1000years.txt');
%  HP.MFD = 0; % already considered, the minimum environmental flow (m3/s)
...
Par_info.min = [dmin qt 0.2 ti 0.501];  % If 'latin', min values
Par_info.max = [5.00 20 10.0 tj 3.499];   % If 'latin', max values
